...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('type', sa.Enum('server', 'client', 'custom', name='certificatetype', create_type=False), nullable=True),
        sa.Column('key_algorithm', sa.Enum('RSA', 'EC', name='keyalgorithm', create_type=False), nullable=True),
